    ...
    try {
      ...
      if (!groqKey) {
        setMessages((prev) => [
          ...
          {
            role: "assistant",
            content: "AI Analyst offline: GROQ_API_KEY not configured.",
          },
        ]);
        setIsTyping(false);
        return;
        ...
        "https://api.groq.com/openai/v1/chat/completions",
        {
          ...
          body: JSON.stringify({
            ...
            messages: [
              {
                role: "system",
                content: `You are the Atlas Arc AI Analyst, a specialized AI for the Atlas Arc Agentic Economy. 
      ...
      const assistantMessage =
        ...
        "Neural link unstable. Calibration required.";
      setMessages((prev) => [
        ...prev,
      ...
      setMessages((prev) => [
        ...
        {
          role: "assistant",
          content: "Error: Failed to connect to Groq Inference Cloud.",
        },
      ]);
    } finally {
      setIsTyping(false);
